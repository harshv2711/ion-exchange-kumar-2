        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
                <div className="w-8 h-8 rounded bg-blue-600 flex items-center justify-center text-white font-bold text-sm">IE</div>
                <span className="font-bold text-lg text-gray-900">ION EXCHANGE</span>
            </div>
            ...
            <div className="flex gap-4">
               ...
               <a href="#" className="text-gray-500 hover:text-blue-600 transition-colors" aria-label="YouTube">
                 <Youtube size={28} fill="currentColor" strokeWidth={0} className="-mt-0.5" />
               </a>
            </div>
          </div>
