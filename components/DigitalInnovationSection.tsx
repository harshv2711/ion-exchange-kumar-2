    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4 max-w-[1320px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[minmax(180px,auto)]">
          ...
          <div className="md:col-span-2 md:row-span-2 bg-blue-600 rounded-2xl p-8 text-white flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="mt-8 relative z-10">
               <button className="bg-white text-blue-600 px-6 py-2 rounded-full font-semibold text-sm hover:bg-blue-50 transition-colors">
                  Learn More
               </button>
            </div>
          </div>
